...
interface TypewriterProps {
  ...
  duration?: number
  delay?: number
  animationType?: "typewriter" | "fadeWord" | "slideWord" | "scaleWord"
...
function Typewriter({
  ...
  const renderAnimatedText = () => {
    ...
    // For word-based animations
    return (
      <motion.span className={className}>
        {words.map((word, index) => {
          const wordDelay = delay + (index * duration) / words.length

          if (animationType === "fadeWord") {
            return (
              <motion.span
                key={index}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.6, delay: wordDelay }}
                className={
                  enableGradient && index === words.length - 1
          ...
          if (animationType === "slideWord") {
            return (
              <motion.span
                key={index}
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: wordDelay, ease: "easeOut" }}
                className={
                  enableGradient && index === words.length - 1
                    ? "bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"
                    : ""
          ...
          if (animationType === "scaleWord") {
            return (
              <motion.span
                key={index}
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5, delay: wordDelay, ease: "backOut" }}
                className={
                  enableGradient && index === words.length - 1
                    ? "bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"
                    : ""
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const newIndex = Math.floor(elapsed / timePerChar)
...
const projects = [
  {
    ...
    title: "Interactify CMS Dashboard",
    description:
      "A clean, user-friendly interface for tracking key metrics like user activity, campaign performance, and engagement analytics.",
    image: "/assets/Admin Home.svg",
    tags: ["UI/UX", "Mobile", "Figma"],
    link: "https://www.figma.com/design/Qwfov0us3w1WqHQZ2HtfW7/Portfolio?node-id=4-9178&p=f&t=A46qXQ8paBXPwXvB-0",
  },
  {
    ...
    title: "Connectivity Solutions",
    description:
      "Cloud-based connectivity solution linking enterprise locations, IoT devices, SaaS applications, and external networks with secure, scalable routing.",
    image: "/assets/cloud.svg",
    tags: ["UI/UX", "Mobile", "Figma"],
    link: "https://www.figma.com/design/Qwfov0us3w1WqHQZ2HtfW7/Portfolio?node-id=4-14800&p=f&t=A46qXQ8paBXPwXvB-0",
  },
  {
    ...
    title: "Rivas Web App",
    description:
      "Rivas is a sleek, responsive movie streaming site with a modern UI for a smooth and engaging user experience, offering users an experience similar to Netflix.",
    image: "/assets/rivas.svg",
    tags: ["UI/UX", "Mobile", "Figma"],
    link: "https://www.figma.com/design/Qwfov0us3w1WqHQZ2HtfW7/Portfolio?node-id=0-1&p=f&t=A46qXQ8paBXPwXvB-0",
  },
  {
    ...
    title: "E-Commerce web",
    description:
      "A clean user friendly e-commerce website with product listings, secure checkout, user authentication, and order management",
    image: "/assets/storeimg.svg",
    tags: ["UI/UX", "Mobile", "Figma"],
    link: "https://www.figma.com/design/Qwfov0us3w1WqHQZ2HtfW7/Portfolio?node-id=6-20744&p=f&t=A46qXQ8paBXPwXvB-0",
  },
          ...
          >
            ...
            <motion.div style={{ y: yRange }} className="max-w-6xl mx-auto relative z-10">
              <motion.div variants={staggerContainer} initial="initial" animate="animate" className="text-center">
                ...
                <motion.p variants={fadeInUp} className="text-xl text-slate-700 mb-8 max-w-2xl mx-auto">
                  In a world where every pixel tells a story, I design experiences that go beyond the screen. Through
                  intuitive interfaces, thoughtful interactions, and human-centered solutions, I bridge the gap between
                ...
                >
                  ...
                  >
                    <motion.div
                      ...
                      className="w-72 h-72 bg-white rounded-full flex items-center justify-center"
                    >
                      <Image src="/assets/ben.jpg" alt="Profile" width={250} height={250} className="rounded-full" />
                    </motion.div>
                  </motion.div>
                </motion.div>
              </motion.div>
